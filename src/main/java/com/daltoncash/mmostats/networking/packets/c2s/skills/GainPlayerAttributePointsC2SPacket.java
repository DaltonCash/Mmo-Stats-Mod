...
public class GainPlayerAttributePointsC2SPacket {

	public GainPlayerAttributePointsC2SPacket() {

	}

	public GainPlayerAttributePointsC2SPacket(FriendlyByteBuf buf) {
	...
	public boolean handle(Supplier<NetworkEvent.Context> supplier) {
		...
		context.enqueueWork(() -> {
			...
			player.getCapability(PlayerAttributePointsProvider.PLAYER_ATTRIBUTE_POINTS).ifPresent(playerAttributePoints -> {
				playerAttributePoints.addPlayerAttributePoints(1);
