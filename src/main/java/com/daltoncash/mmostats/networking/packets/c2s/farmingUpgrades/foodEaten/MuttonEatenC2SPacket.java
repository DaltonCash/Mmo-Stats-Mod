...
public class MuttonEatenC2SPacket {

	public MuttonEatenC2SPacket() {

	}

	public MuttonEatenC2SPacket(FriendlyByteBuf buf) {
	...
	public boolean handle(Supplier<NetworkEvent.Context> supplier) {
		...
		context.enqueueWork(() -> {
			...
			player.getCapability(MuttonEatenProvider.SUM).ifPresent(total -> {
				total.addSum(1);
				ModMessages.sendToPlayer(new MuttonEatenDataSyncS2CPacket(total.getSum()), player);
			});
		});
		return true;
	}
