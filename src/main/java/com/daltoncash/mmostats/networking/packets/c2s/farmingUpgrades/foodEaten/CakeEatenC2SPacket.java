...
public class CakeEatenC2SPacket {

	public CakeEatenC2SPacket() {

	}

	public CakeEatenC2SPacket(FriendlyByteBuf buf) {
	...
	public boolean handle(Supplier<NetworkEvent.Context> supplier) {
		...
		context.enqueueWork(() -> {
			...
			player.getCapability(CakeEatenProvider.SUM).ifPresent(total -> {
				total.addSum(1);
				ModMessages.sendToPlayer(new CakeEatenDataSyncS2CPacket(total.getSum()), player);
			});
		});
		return true;
	}
