...
public class UpgradeMenu extends Screen{
	...
	private final ResourceLocation bgtexture = new ResourceLocation(MmoStatsMod.MODID, "textures/gui/cobble_bg-2.png.png");
	...
	public final void init() {
		...
		addRenderableWidget(new Button(20,200,100,100, Component.literal("reset capabilities: " + ClientCapabilityData.getPlayerMiningLevel()), UpgradeMenu::onPressReset));
