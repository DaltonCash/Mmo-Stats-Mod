package com.daltoncash.mmostats.entities.client.companion_goals;
...
public class LookAtPlayer extends Goal {
   ...
   public LookAtPlayer(Mob p_25520_, Class<? extends LivingEntity> p_25521_, float p_25522_) {
      this(p_25520_, p_25521_, p_25522_, 0.02F);
   }

   public LookAtPlayer(Mob p_25524_, Class<? extends LivingEntity> p_25525_, float p_25526_, float p_25527_) {
      this(p_25524_, p_25525_, p_25526_, p_25527_, false);
   }

   public LookAtPlayer(Mob Companion, Class<? extends LivingEntity> p_148119_, float p_148120_, float p_148121_, boolean p_148122_) {
      this.mob = Companion;
      ...
      if (p_148119_ == Player.class) {
         this.lookAtContext = TargetingConditions.forNonCombat().range((double)p_148120_).selector((p_25531_) -> {
            return EntitySelector.notRiding(Companion).test(p_25531_);
         });
      } else {
