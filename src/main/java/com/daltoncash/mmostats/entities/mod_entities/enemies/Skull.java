...
public class Skull extends Monster implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	
	
	public Skull(EntityType<? extends Monster> p_33002_, Level p_33003_) {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<Skull>(this, "moving", 0, this::movingAnimation));
	}
	...
	public AnimationFactory getFactory() {
	 ...
	 private <E extends IAnimatable> PlayState movingAnimation(AnimationEvent<E> event) {
		if (event.isMoving()) {
			event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.skull.walk", true));
