...
public class Urchin extends Monster implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	
	
	public Urchin(EntityType<? extends Monster> p_33002_, Level p_33003_) {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<Urchin>(this, "moving", 0, this::movingAnimation));
	}
